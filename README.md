...
```bash
npm install @stdlib/random-streams-mt19937
```
...
```bash
npm install -g @stdlib/random-streams-mt19937
```
...
[test-image]: https://github.com/stdlib-js/random-streams-mt19937/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/random-streams-mt19937/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-mt19937
